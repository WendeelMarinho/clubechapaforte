...
return [
    ...
    */
    ...
    "remove_points_from_balance" => "Remove points from balance",
    "points_removed_success" => "Points removed successfully.",
    "remove_points" => "Remove points",
    "insufficient_points_to_remove" => "The member does not have enough points for this deduction.",
    "staff_points_debited" => "Points adjusted by staff",
